...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Add Student Form -->
            <form action="<?php echo e(route('students.store')); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
                <?php echo csrf_field(); ?>

                <div class="mb-4">
                    <label class="block text-gray-700">Student No:</label>
                    <input type="text" name="studentno" value="<?php echo e(old('studentno')); ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="middlename" value="<?php echo e(old('middlename')); ?>"
                           class="w-full border rounded px-3 py-2 mt-1 focus:outline-none focus:ring focus:ring-blue-300">
                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SCS\resources\views/students/create.blade.php ENDPATH**/ ?>